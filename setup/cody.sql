...
--
-- Host: db
-- Generation Time: Jul 09, 2023 at 06:50 PM
...
CREATE TABLE `user` (
  ...
  `preferredfirstname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `preferredlastname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
